...
- (JHFloatDanmaku *)floatDanmakuWithFontSize:(CGFloat)fontSize textColor:(UIColor *)textColor text:(NSString *)text direction:(JHFloatDanmakuPosition)direction{
    return [[JHFloatDanmaku alloc] initWithFont:[UIFont systemFontOfSize:fontSize] text:text textColor:textColor effectStyle:JHDanmakuEffectStyleShadow during:3 position:direction];
}
